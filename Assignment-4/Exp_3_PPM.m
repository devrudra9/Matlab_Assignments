...
plot(y1);
axis([0 100 -0.2 1.2]);
title("PPM y1, One cycle of f1, fc = 1000, f1 = 200");
...
subplot(3, 2, 5);
plot(f, fx1);
title("Frequency description of PPM, single tone, fc = 1000");
...
subplot(3, 2, 4);
y2 = modulate(x2, fc, fs, 'ppm');
plot(y2);
axis([0 100 -0.2 1.2]);
title("PPM y2, One cycle of f1, fc = 1000, f1 = 200");

fx2 = abs(fft(y2,1024));
fx2 = [fx2(514:1024) ,fx2(1:513)];
subplot(3, 2, 6);
plot(f, fx2);
title("Frequency description of PPM, double tone, fc = 1000");
